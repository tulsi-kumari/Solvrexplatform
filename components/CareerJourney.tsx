...
const styles = `
  ...
  @media (max-width: 760px) {
    ...
    .sx-cj-node { flex-direction: row; align-items: center; text-align: left; gap: 16px; padding: 14px 0; }
    .sx-cj-label { max-width: none; }
    .sx-cj-track { top: 14px; bottom: 14px; left: 6px; right: auto; width: 1px; height: auto; }
...
export function CareerJourney() {
  return (
    <section style={{ padding: "76px 0", borderBottom: `1px solid ${C.border}` }}>
      <div className="sx-container">
        <p style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.textSubtle, marginBottom: "36px", textAlign: "center" }}>
          The career journey
        </p>
        <style>{styles}</style>
        <div className="sx-cj">
